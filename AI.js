...
const handleVoice = (text) => {
    ...
    const container = document.querySelector('.nen');
    ...
    if(handledText.includes('các loại'))
    {
        const location = handledText.split('loại')[1].trim();
         retrieve (location);
        return;
    }
 ...
 if (handledText.includes('nghe nhạc')) {
        ...
        openWindow("file:///D:/Hoc/Demo%20AI/index.html");
        return;
}
